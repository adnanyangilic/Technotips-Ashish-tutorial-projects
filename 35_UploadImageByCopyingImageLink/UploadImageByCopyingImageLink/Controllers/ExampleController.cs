...
using UploadImageByCopyingImageLink.Models.MenuModels;
using UploadImageByCopyingImageLink.Models.ViewModels;
...
namespace UploadImageByCopyingImageLink.Controllers
{
    public class ExampleController : Controller
    {
        ...
        {
            return db.SiteUser.SingleOrDefault(x => x.EmailID == loginViewModel.EmailID && x.Password == loginViewModel.Password);
        }
        ...
        private void RegisterNewUserInDB(EmployeesDBEntities db, RegistrationViewModel registrationViewModel)
        {
            ...
            {
                /// SiteUser mentése
                db.SiteUser.Add(CreateNewSiteUser(db, registrationViewModel));
                db.SaveChanges();
            }
            catch (Exception ex)
            {
