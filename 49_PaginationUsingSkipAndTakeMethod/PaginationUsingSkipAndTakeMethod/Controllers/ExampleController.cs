using PaginationUsingSkipAndTakeMethod.Models;
using PaginationUsingSkipAndTakeMethod.Models.ViewModels;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Web.Mvc;

namespace PaginationUsingSkipAndTakeMethod.Controllers
{
    public class ExampleController : Controller
    {
        ...
        [HttpPost]
        public JsonResult LoginUser(LoginViewModel loginViewModel)
        {
            string result = "";
        ...
        ///     állapotban
        /// </returns>
        private List<MenuItemViewModel> GetMenuItemsWhenLogOut()
        {
            List<MenuItemViewModel> menuItemsList = new List<MenuItemViewModel>
            {
                new MenuItemViewModel { Link = "/Home/Index", LinkName = "Kezdőlap" },
                new MenuItemViewModel { Link = "/Example/Login", LinkName = "Bejelentkezés" },
                new MenuItemViewModel { Link = "/Example/Registration", LinkName = "Regisztráció" }
            };
        ...
        ///     állapotban
        /// </returns>
        private List<MenuItemViewModel> GetMenuItemsWhenUserLogIn()
        {
            List<MenuItemViewModel> menuItemsList = new List<MenuItemViewModel>
            {
                new MenuItemViewModel { Link = "/Example/Index", LinkName = "Kezdőlap" },
                new MenuItemViewModel { Link = "/Example/Logout", LinkName = "Kijelentkezés" },
            };
